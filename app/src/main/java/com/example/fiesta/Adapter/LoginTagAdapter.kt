...
class LoginTagAdapter(val Parent: Activity, val TagArray: JSONArray, val ImgArray: JSONArray, val addArray: ArrayList<String>, val addTag: (TagName: String) -> Unit, val delTag: (TagName: String) -> Unit) : RecyclerView.Adapter<LoginTagAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LoginTagAdapter.ViewHolder {
